...
class BankService {
  constructor() {
    this.paystackSecretKey = process.env.PAYSTACK_SECRET_KEY || 'sk_test_0878d8880fb3c31445795a4b632941c3f2cba4ec';
  ...
  async verifyBankAccount(accountNumber, bankCode) {
    try {
      ...
      logger.error('Error verifying bank account', { error, accountNumber, bankCode });
